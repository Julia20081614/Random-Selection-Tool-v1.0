...
namespace RandomSelectionTool
{
    public partial class Form1 : Form
    {
        ...
        private const string REG_KEY_FOLDER = "Directory\\background\\shell\\Click on Sweet 16 button";
        private const string REG_KEY_LIBRARY = "LibraryFolder\\background\\shell\\Click on Sweet 16 button";
